...
| API 목록      | URL                                 | 예상 일정 | 예상 소요 시간 | 개발 일정 | 개발 시간 | 작업 결과서                                                  |
| ------------- | ----------------------------------- | --------- | -------------- | --------- | --------- | ------------------------------------------------------------ |
| 장바구니 조회 | get : /carts/{user-pk}              |           |                |           |           | [문서](https://github.com/hanseonghye/ShoppingmallProject/blob/master/docs/2.Swagger%26TDD/api/%EC%9E%A5%EB%B0%94%EA%B5%AC%EB%8B%88%EC%A1%B0%ED%9A%8C%2B%EC%B6%94%EA%B0%80.md) |
| 장바구니 추가 | post : /carts/{user-pk}             |           |                |           |           | [문서](https://github.com/hanseonghye/ShoppingmallProject/blob/master/docs/2.Swagger%26TDD/api/%EC%9E%A5%EB%B0%94%EA%B5%AC%EB%8B%88%EC%A1%B0%ED%9A%8C%2B%EC%B6%94%EA%B0%80.md) |
| 장바구니 수정 | put : /carts/{user-pk}/{cart-pk}    |           |                |           |           | [문서](https://github.com/hanseonghye/ShoppingmallProject/blob/master/docs/2.Swagger%26TDD/api/%EC%9E%A5%EB%B0%94%EA%B5%AC%EB%8B%88%20%EC%88%98%EC%A0%95%2B%EC%82%AD%EC%A0%9C.md) |
| 장바구니 삭제 | delete : /carts/{user-pk}/{cart-pk} |           |                |           |           | [문서](https://github.com/hanseonghye/ShoppingmallProject/blob/master/docs/2.Swagger%26TDD/api/%EC%9E%A5%EB%B0%94%EA%B5%AC%EB%8B%88%20%EC%88%98%EC%A0%95%2B%EC%82%AD%EC%A0%9C.md) |
...
| API 목록      | URL                                           | 예상 일정 | 예상 소요 시간 | 개발 일정 | 개발 시간 | 작업 결과서                                                  |
| ------------- | --------------------------------------------- | --------- | -------------- | --------- | --------- | ------------------------------------------------------------ |
| 주문하기      | post : /orders                                |           |                |           |           | [문서](https://github.com/hanseonghye/ShoppingmallProject/blob/master/docs/2.Swagger%26TDD/api/%EC%A3%BC%EB%AC%B8%ED%95%98%EA%B8%B0.md) |
| 주문 조회     | get : /orders/{user-pk or user_id}            |           |                |           |           | [문서](https://github.com/hanseonghye/ShoppingmallProject/blob/master/docs/2.Swagger%26TDD/api/%EC%A3%BC%EB%AC%B8%EC%A1%B0%ED%9A%8C.md) |
| 특정 주문조회 | get : /orders/{user-pk or user_id}/{order-pk} |           |                |           |           | [문서](https://github.com/hanseonghye/ShoppingmallProject/blob/master/docs/2.Swagger%26TDD/api/%EC%A3%BC%EB%AC%B8%EC%A1%B0%ED%9A%8C(%ED%8A%B9%EC%A0%95).md) |
...
| API 목록         | URL                          | 예상 일정 | 예상 소요 시간 | 개발 일정 | 개발 시간 | 작업 결과서                                                  |
| ---------------- | ---------------------------- | --------- | -------------- | --------- | --------- | ------------------------------------------------------------ |
| 전체 관리자 조회 | get : /admin/manager         |           |                |           |           | [문서](https://github.com/hanseonghye/ShoppingmallProject/blob/master/docs/2.Swagger%26TDD/api/%EA%B4%80%EB%A6%AC%EC%9E%90%EC%A1%B0%ED%9A%8C%2B%EB%93%B1%EB%A1%9D.md) |
| 관리자 등록      | post : /admin/manager        |           |                |           |           | [문서](https://github.com/hanseonghye/ShoppingmallProject/blob/master/docs/2.Swagger%26TDD/api/%EA%B4%80%EB%A6%AC%EC%9E%90%EC%A1%B0%ED%9A%8C%2B%EB%93%B1%EB%A1%9D.md) |
| 특정 관리자 조회 | get : /admin/manager/{id}    |           |                |           |           | [문서](https://github.com/hanseonghye/ShoppingmallProject/blob/master/docs/2.Swagger%26TDD/api/%EA%B4%80%EB%A6%AC%EC%9E%90%EC%A1%B0%ED%9A%8C%2B%EC%88%98%EC%A0%95%2B%EC%82%AD%EC%A0%9C.md) |
| 관리자 정보 수정 | put : /admin/manager/{id}    |           |                |           |           | [문서](https://github.com/hanseonghye/ShoppingmallProject/blob/master/docs/2.Swagger%26TDD/api/%EA%B4%80%EB%A6%AC%EC%9E%90%EC%A1%B0%ED%9A%8C%2B%EC%88%98%EC%A0%95%2B%EC%82%AD%EC%A0%9C.md) |
| 관리자 삭제      | delete : /admin/manager/{id} |           |                |           |           | [문서](https://github.com/hanseonghye/ShoppingmallProject/blob/master/docs/2.Swagger%26TDD/api/%EA%B4%80%EB%A6%AC%EC%9E%90%EC%A1%B0%ED%9A%8C%2B%EC%88%98%EC%A0%95%2B%EC%82%AD%EC%A0%9C.md) |
...
| API 목록          | URL                                 | 예상 일정 | 예상 소요 시간 | 개발 일정 | 개발 시간 | 작업 결과서                                |
| ----------------- | ----------------------------------- | --------- | -------------- | --------- | --------- | ------------------------------------------ |
| 상품 등록         | post : /admin/products              |           |                |           |           | [문서](docs/2.Swagger&TDD/api/상품등록.md) |
...
| API 목록  | URL                      | 예상 일정 | 예상 소요 시간 | 개발 일정 | 개발 시간 | 작업 결과서 |
| --------- | ------------------------ | --------- | -------------- | --------- | --------- | ----------- |
| 주문 조회 | get : /admin/orders      |           |                |           |           |             |
| 주문 수정 | put : /admin/orders/{id} |           |                |           |           |             |
